...
<h2><?php  __('Essay');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		...
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Revision Count'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $essay['Essay']['revision_count']; ?>
			&nbsp;
		</dd>
	</dl>
</div>
...
<div class="related">
	...
	<?php
		...
		<tr<?php echo $class;?>>
			...
			<td><?php echo $revision['rating'];?></td>
...
<?php endif; ?>
	...
	<div class="actions">
		<ul>
			<li><?php echo $this->Html->link(__('Add revision', true), array('controller' => 'revisions', 'action' => 'add', 'essay_id' => $essay['Essay']['id']));?> </li>
		</ul>
	</div>
</div>
